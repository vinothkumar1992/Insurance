...
<h5 class="text-muted text-center" style="margin-top:0;margin-bottom:0;font-weight:500;color:#636c72;vertical-align:baseline;font-size:20px;line-height:24px" align="center"> User Email :  <?php echo $email; ?> </h5>
<h5 class="text-muted text-center" style="margin-top:0;margin-bottom:0;font-weight:500;color:#636c72;vertical-align:baseline;font-size:20px;line-height:24px" align="center">Password :  <?php echo $password; ?> </h5>
...
<a href="<?php echo $link; ?>" style="font-size:20px;font-family:Helvetica,Arial,sans-serif;text-decoration:none;border-radius:4.8px;line-height:30px;display:inline-block;font-weight:normal;white-space:nowrap;background-color:#007bff;color:#fff;padding:8px 16px;border:1px solid #007bff">Your Login Link </a>
</td>
</tr>
</tbody>
</table>
