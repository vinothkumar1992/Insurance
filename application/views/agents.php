										...
										<div class="kt-portlet__head-wrapper">
											...
											<div class="dropdown">
												 ...
												 Add New Consultants
												            ...
												            <a class="dropdown-item" href="<?php echo base_url();?>Consultants/addagent"><i class="la la-edit"></i> Create New Agent Form </a>
																<button class="dropdown-item" data-toggle="modal" data-target="#sendagentlink" data-record-id2=0 ><i class="la la-link"></i> Send New Agent Form Link</a></button>
																</div>
															</div>
...
<!-- end:: Footer -->
 ...
 <?php $this->load->view('agentform'); ?>
  ...
  <!-- Model Link End -->
	...
	<script>
	function sendEmailPasswd(email,name,id) {
		       
		   $.ajax({url: window.location.origin+'/MAEM/Consultants/sendEmailPassword?agent_email='+email+'&agent_id='+id+'&agent_name='+name,
