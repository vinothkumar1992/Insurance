...
<!-- begin:: Content -->
	...
	<?php echo form_open(base_url()."Agents/test",array('id'=>'kt_form','class'=>'kt-form','method'=>'post')); ?>
															...
															<div class="form-group">
																<label>Title</label>
																	<select name="agent_level" id="agent_level" class="form-control">
																		...
																		<option value="IB">Introduced By</option>
																	</select>
													...
													<div class="kt-form__section kt-form__section--first">
														...
														<div class="form-group">
															...
															<div class="kt-radio-inline mb-2">
																...
																<label class="kt-radio">
																	<input type="radio" name="other_ans"  id="other_ans1" value="No"> No
																	<span></span>
																</label>
															</div>
												...
												<div class="kt-wizard-v2__content" data-ktwizard-type="step-content">
													...
													<div class="kt-form__section kt-form__section--first">
														<div class="kt-wizard-v2__review">
															...
															<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" name="agent_bank_name" >
																	<span class="form-text text-muted"></span>
																</div>
															</div>
															<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
														...
														<div class="form-group">
															...
															<input type="text" class="form-control" name="agent_bank_accountname" >
															<span class="form-text text-muted"></span>
														</div>
													<div class="row">
													
													<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12"> 
													<label>NRIC Copy upload</label>
														<div class="form-group">
