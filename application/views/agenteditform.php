										...
										<h4 class="kt-portlet__head-title "style="font-size: 1.2rem;">PERSONAL INFORMATION</h4>
												<div class="form-group row form-group-marginless kt-margin-t-10">
													...
													<label>Name (as in NRIC / Name (seperti dalam K.P.): </label>
														<input type="text" class="form-control" id="agent_name1" name="agent_name" oninput="this.value = this.value.toUpperCase()">
														
													</div>
													
													<div class="col-lg-3">
													<label>New NRIC / Passport No / No. K.P. Baru / Pasport:</label>
														<input type="text" class="form-control" id="agent_nric_no1" name="agent_nric_no">
											
													</div>
													
													<div class="col-lg-3">
													<label>Age / Age:</label>
														<input type="text" class="form-control" id="agent_age1" name="agent_age">
													...
													<label>Address 1 / Alamat 1:</label>
														<input type="text" class="form-control" name="agent_address1" id="agent_address11">
												...
												<div class="form-group row form-group-marginless kt-margin-t-5">
													...
													<label>Address 2 / Alamat 2:</label>
														<input type="text" class="form-control" name="agent_address2" id="agent_address21">
														<span class="form-text text-muted"></span>
													</div>
													
													<div class="col-lg-3">
													<label>Address 3 / Alamat 3:</label>
														<input type="text" class="form-control" name="agent_address3" id="agent_address31">
													
													</div>
													
													<div class="col-lg-3">
													<label>City / Bandar:</label>
														<input type="text" class="form-control" name="agent_city" id="agent_city1">
													...
													<label>Country / Negara:</label>
														<select class="form-control kt-selectpicker" data-size="5" data-live-search="true" id="agent_country1" name="agent_country">
													...
													<label>Telephone No / No. Telefon:</label>
														<input type="text" class="form-control" name="agent_home_office_no" id="agent_home_office_no1">
													...
													<label>Mobile Phone / Telefon Bimbit:</label>
														<input type="text" class="form-control" name="agent_phone_no" id="agent_phone_no1">
													...
													<label>Date of Birth / Tarikh Lahir:</label>
														<input type="text" class="form-control" id="kt_datepicker_1" readonly placeholder="Select date" name="agent_dob" id="date_of_birth1" />
														
													</div>
													
													<div class="col-lg-3">
													<label>Gender / Jantina:</label>
														<select class="form-control kt-selectpicker" data-size="5" data-live-search="true" name="agent_gender" id="agent_gender1" >
															<option value=""></option>
													...
													<label>Race / Bangsa:</label>
														<select class="form-control kt-selectpicker" data-size="5" data-live-search="true" name="agent_race" id="agent_race1">
															<option value=""></option>
												...
												<div class="col-lg-3">
													<label>Marital Status / Taraf Perkahwinan:</label>
														<select class="form-control kt-selectpicker" data-size="5" data-live-search="true" name="agent_marital_status" id="agent_marital_status1">
															<option value=""></option>
													...
													<label>Category:</label>
														<select class="form-control kt-selectpicker" data-size="5" data-live-search="true" name="agent_level" id="agent_level1">
															<option value=""></option>
													...
													<label>Referral:</label>
																			<input type="text" class="form-control" name="agent_intro" id="agent_intro1">
														
													</div>

<div class="col-lg-3">
													<label>Email / Emel:</label>
														<input type="text" class="form-control" name="agent_email" id="agent_email1">
...
<div class="col-lg-3">
												...
												<h4 class="kt-portlet__head-title "style="font-size: 1.2rem;">BANK INFORMATION</h4>
													...
													<label>Bank Name:</label>
																			<input type="text" class="form-control" name="agent_bank_name" id="agent_bank_name1">
														
													</div>
													<div class="col-lg-3">
													<label>Bank A/C No:</label>
																			<input type="text" class="form-control" name="agent_bank_ac_no" id="agent_bank_ac_no1">
													...
													<label >Active Status:</label>
														<div class="kt-radio-inline">
															<label class="kt-radio kt-radio--solid">
																<input type="radio" id="agent_status1" name="agent_status" value="1"> Active
																<span></span>
															</label>
															<label class="kt-radio kt-radio--solid">
																<input type="radio"  id="agent_status2"  name="agent_status" value="0"> De-Active
																<span></span>
															</label>
														</div>
												...
												<div class="form-group row form-group-marginless kt-margin-t-10">
													...
													<input type="hidden" name="agent_sign" id ="agent_sign1"/>
													<img  id="sign_imag" >
													</center>
													</div>
