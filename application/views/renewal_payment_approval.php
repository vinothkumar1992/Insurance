...
<div class="row row-no-padding row-col-separator-xl">
														...
														<div class="col-md-12 col-lg-12 col-xl-3">
															...
															<div class="kt-widget1">
																...
																<div class="kt-widget1__item">
																	...
																	<div class="kt-widget1__item">
																	<div class="kt-widget1__info">
																		<h3 class="kt-widget1__title">Memeber Sign</h3>
										...
										<?php } else { ?>
												...
												<img src="<?php echo $payment_img; ?>" class="img-fluid">
											...
											<div class="kt-widget1">
												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<?php echo form_open(base_url()."Renewal/renewal_payment_approval_do",array('class'=>'kt-form kt-form--label-right','method'=>'post')); ?>
...
<!-- end:: Footer -->
  ...
  <!-- The Modal  End -->
	...
	<!-- begin::Global Config(global config for global JS sciprts) -->
		...
		<script src="<?php echo base_url();?>assets/js2/rpa.js?v=<?php echo date("ymdhmi");?>" type="text/javascript"></script>
