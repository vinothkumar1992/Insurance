...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							<div class="kt-portlet">
								...
								<div class="kt-portlet__body kt-portlet__body--fit">
									<div class="kt-grid  kt-wizard-v2 kt-wizard-v2--white" id="kt_wizard_v2" data-ktwizard-state="step-first">
										...
										<?php echo form_open_multipart(base_url()."Formsubmission/form_submit?token=".$token."_".$mytoken,array('id'=>'kt_form','class'=>'kt-form kt-form--label-right','method'=>'post')); ?>	
	...
	<div class="col-xl-3">
													...
													<span class="form-text text-muted"></span>
															...
															<select class="form-control kt-selectpicker" data-size="5" data-live-search="true" id="state" name="state">
																			<option value="">Select</option>
			...
			<div class="row">
												...
												<div class="kt-wizard-v2__content" data-ktwizard-type="step-content">
													...
													Adakah orang yang dilindungi mempunyai sebarang kecacatan atau penyakit?" />
														...
														<label class="kt-radio" align="right">
...
Pernahkah orang yang dilindungi mengalami sebarang pembedahan?" />
										...
										<div class="kt-separator kt-separator--space-lg kt-separator--border-dashed"></div>			
													...
													<div>
Pernahkah orang yang dilindungi dimasukkan ke hospital untuk sebarang penyakit atau kecederaan?</div>
...
<div class="row">
												...
												<div class="kt-wizard-v2__content" data-ktwizard-type="step-content">
													...
													<div></div>
													<div class="custom-file">
														<input type="file" name="nric_upd2" class="custom-file-input" id="customFile2">
														<label class="custom-file-label selected" for="customFile"></label>
													</div>
												</div>
																</div>
													...
													<div></div>
													<div class="custom-file">
														<input type="file" name="nric_upd3" class="custom-file-input" id="customFile3">
														<label class="custom-file-label selected" for="customFile"></label>
													</div>
												</div>
																</div>
													...
													<div></div>
													<div class="custom-file">
														<input type="file" name="nric_upd4" class="custom-file-input" id="customFile4">
														<label class="custom-file-label selected" for="customFile"></label>
													</div>
												</div>
																</div>
...
<?php  $this->load->view("signform1");?>
    ...
    <script src="<?php echo base_url();?>assets/js/memberformwz.js?v=<?php echo date("ymdhmi")?>" type="text/javascript"></script>
