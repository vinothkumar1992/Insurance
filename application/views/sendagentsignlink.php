<div id="sendagentsignlink" class="modal fade" role="dialog" aria-hidden="true">
											...
											<div class="kt-portlet__body">
												...
												<div class="form-group row form-group-marginless kt-margin-t-20 kt-margin-b-20">
													...
													<div class="input-group">
															...
															<input type="hidden" name="agentid" id="agentid4" >
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-7">
															<button type="button" class="btn btn-brand" id="sendAgentSignLink">Send</button>
