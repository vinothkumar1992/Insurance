...
<table valign="top" class="bg-light body" style="outline:0;width:100%;min-width:100%;height:100%;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;font-family:Helvetica,Arial,sans-serif;line-height:24px;font-weight:normal;font-size:16px;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;mso-table-lspace:0;mso-table-rspace:0;border-spacing:0;border-collapse:collapse;margin:0;padding:30px;border:0" bgcolor="#f8f9fa">
<tbody>
<tr>
<td valign="top" style="border-spacing:0;border-collapse:collapse;line-height:24px;font-size:16px;margin:0" align="left" bgcolor="#f8f9fa">
<table class="container" border="0" cellpadding="0" cellspacing="0" style="font-family:Helvetica,Arial,sans-serif;mso-table-lspace:0;mso-table-rspace:0;border-spacing:0;border-collapse:collapse;width:100%">
<tbody>
<tr>
<td align="center" style="border-spacing:0;border-collapse:collapse;line-height:24px;font-size:16px;margin:0;padding:0 16px">
<!--[if (gte mso 9)|(IE)]>
<table align="center">
<tbody>
<tr>
<td width="600">
<![endif]-->
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:Helvetica,Arial,sans-serif;mso-table-lspace:0;mso-table-rspace:0;border-spacing:0;border-collapse:collapse;width:100%;max-width:600px;margin:0 auto">
<tbody>
<tr>
<td style="border-spacing:0;border-collapse:collapse;line-height:24px;font-size:16px;margin:0" align="left">
<table class="card" border="0" cellpadding="0" cellspacing="0" style="font-family:Helvetica,Arial,sans-serif;mso-table-lspace:0;mso-table-rspace:0;border-spacing:0;border-collapse:separate!important;border-radius:4px;width:100%;overflow:hidden;border:1px solid #dee2e6" bgcolor="#ffffff">
<tbody>
<tr>
<td style="border-spacing:0;border-collapse:collapse;line-height:24px;font-size:16px;width:100%;margin:0" align="left">
<div style="border-top-width:5px;border-top-color:#daa520;border-top-style:solid">
<table class="card-body" border="0" cellpadding="0" cellspacing="0" style="font-family:Helvetica,Arial,sans-serif;mso-table-lspace:0;mso-table-rspace:0;border-spacing:0;border-collapse:collapse;width:100%">
<tbody>
<tr>
<td style="border-spacing:0;border-collapse:collapse;line-height:24px;font-size:16px;width:100%;margin:0;padding:20px" align="left">
<div>
<table class="mx-auto" align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:Helvetica,Arial,sans-serif;mso-table-lspace:0;mso-table-rspace:0;border-spacing:0;border-collapse:collapse;margin:0 auto">
<tbody>
<tr>
<td style="border-spacing:0;border-collapse:collapse;line-height:24px;font-size:16px;margin:0" align="left">
<img class="" width="100" height="100" src="https://myangkasaemas.com/MAEM/assets/media/logos/logo.png?w=100&amp;h=100&amp;dpr=2&amp;fit=crop&amp;mask=ellipse&amp;crop=faces&amp;faceindex=1&amp;fm=png" style="height:auto;line-height:100%;outline:0;text-decoration:none;border:0 none">
</td>
</tr>
</tbody>
</table>
<hr>	
<h5 ><font color="#1D4C9C"><pre class="tab"> Signature's Name : <?php echo $this->input->get("agent_name");?>              NRIC No: <?php echo $this->input->get("agent_nric_no");?> </pre> </font>   </h5>
<h5> Signature : 
<form id="formsubmit" action="<?php echo base_url(); ?>AgentSignExt/signatureSubmit?token=<?php echo $this->input->get("token");?>"  method="post">
<table class="s-2 w-100" border="0" cellpadding="0" cellspacing="0" style="width:100%">
<tbody>
<tr>
<td height="8" style="border-spacing:0;border-collapse:collapse;line-height:8px;font-size:8px;width:100%;height:8px;margin:0" align="left"> 
										...
										<button type="button" class="btn btn-danger" id="clear" >Clear</button>
											<input type="hidden" name="agent_sign" id ="mem_sign"/>
											<input type="hidden" name="token" id ="token1" value = "<?php echo $this->input->get("token");?>"/>
...
<br>
<hr>
<table class="btn btn-primary btn-lg mx-auto" align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:Helvetica,Arial,sans-serif;mso-table-lspace:0;mso-table-rspace:0;border-spacing:0;border-collapse:separate!important;border-radius:4px;margin:0 auto">
<tbody>
<tr>
<td style="border-spacing:0;border-collapse:collapse;line-height:24px;font-size:16px;border-radius:4px;margin:0" align="center" bgcolor="#007bff">
<button type="button"  id ="submitbtn" style="font-size:20px;font-family:Helvetica,Arial,sans-serif;text-decoration:none;border-radius:4.8px;line-height:30px;display:inline-block;font-weight:normal;white-space:nowrap;background-color:#007bff;color:#fff;padding:8px 16px;border:1px solid #007bff">Submit</button>
</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td height="24" style="border-spacing:0;border-collapse:collapse;line-height:24px;font-size:24px;width:100%;height:24px;margin:0" align="left">
 
</td>
</tr>
</tbody>
</table>
<div class="text-center text-muted" style="color:#636c72" align="center">Copyright &copy; <?php echo date("Y");?> <a href="https://myangkasaemas.com/" target="_blank"> My Angkasa Emas Medicare Portal 3.0.0 </a>. </div>
<table class="s-4 w-100" border="0" cellpadding="0" cellspacing="0" style="width:100%">
<tbody>
<tr>
<td height="24" style="border-spacing:0;border-collapse:collapse;line-height:24px;font-size:24px;width:100%;height:24px;margin:0" align="left">
...
alert("Alert : Please Sign the Form and CLick Submit !! ");
	  ...
	  $("#formsubmit").submit();
	   ...
	   var btn = $(this);
			...
			window.location = window.location.origin+'/MAEM/MemberSignExt/signatureSubmit?token='+$("#token1").val();
			/* 

	
 form.ajaxSubmit({
                url: window.location.origin+'/MAEM/MemberSignExt/signatureSubmit?token='+$("#token1").val(),
