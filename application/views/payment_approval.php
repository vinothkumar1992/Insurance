								...
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										<span class="kt-portlet__head-icon">
											<i class="kt-font-brand flaticon2-notepad"></i>
										</span>
...
<ul class="nav nav-pills nav-fill" role="tablist">
												...
												<li class="nav-item">
													<a class="nav-link" data-toggle="tab" href="#kt_tabs_5_2">PRIMARY DETAILS & MEMBERSHIP PACKAGE</a>
												</li>
												<li class="nav-item">
...
<div class="row row-no-padding row-col-separator-xl">
														...
														<div class="col-md-12 col-lg-12 col-xl-3">
															...
															<div class="kt-widget1">
																...
																<div class="kt-widget1__item">
																	<div class="kt-widget1__info">
																		<h3 class="kt-widget1__title">Age:</h3>
																		<span class="kt-widget1__desc"><?php echo $age; ?></span>
																	</div>
										...
										<div class="kt-portlet__head kt-portlet__head--noborder  kt-ribbon kt-ribbon--clip kt-ribbon--right kt-ribbon--border-dash-hor kt-ribbon--warning">
											<div class="kt-ribbon__target" style="top: 12px;">
												<span class="kt-ribbon__inner"></span>Unverified
											</div>
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
										...
										<?php } else { ?>
												...
												<?php if($payment_img!=null) {?>
												<?php echo form_open('MemberForm/cancelslip',array('action'=>'#','class'=>'kt-form kt-form--label-right','method'=>'post')); ?>
												<center>
												<button type="button" id="cancelslip" class="btn btn-danger"> Cancel Banking Slip</button>
												</center>
												<input type="hidden" name="form_orderid" value="<?php echo $form_orderid; ?>" />
												</form>
										<?php } } ?>
										</div>
									</div>
    ...
    padding-left: 470px;
">
														<?php if($payment_img!=null || $ptype=="Online" ) {?>
														<?php echo form_open('#',array('action'=>'#','id'=>'kt-form','class'=>'kt-form kt-form--label-right','method'=>'post')); ?>
														<input type="hidden" name="id" value="<?php echo $id; ?>" />
														<input type="hidden" name="form_orderid" value="<?php echo $form_orderid; ?>" />
													
																	<div class="form-group">
																<label>Payment Date: <span style="color: red;">*</span></label>
																<input type="date" id="dt" class="form-control" name="form_payment_date" id="form_payment_date" onchange="mydate1();" hidden/>
<input type="text" id="ndt" placeholder="dd-mm-yyy" onclick="mydate();" class="form-control"  />
																<span class="form-text text-muted"></span>
															
																<label>Submission Date: <span style="color: red;">*</span></label>
																
																<input type="date" id="dt1" name="form_submission_date" id="form_submission_date" class="form-control" onchange="mydate3();" hidden/>
<input type="text" id="ndt1" placeholder="dd-mm-yyy" onclick="mydate2();" class="form-control"   />
																<span class="form-text text-muted"></span>
															</div>
															
														
															<button type="button" id="pa_pac" class="btn btn-brand">Payment confirm</button>
...
<!-- end:: Footer -->
  ...
  <!-- The Modal  End -->
	...
	<!-- begin::Global Config(global config for global JS sciprts) -->
		...
		<script src="<?php echo base_url();?>assets/js2/pa.js?v=<?php echo date("ymdhmi");?>" type="text/javascript"></script>
...
yy=d.getFullYear();
document.getElementById("ndt").value=('0' + dt).slice(-2) + '-'
             + ('0' + (mn+1)).slice(-2) + '-'
             + yy;
...
mn=d.getMonth();
yy=d.getFullYear();
document.getElementById("ndt1").value=('0' + dt).slice(-2) + '-'
             + ('0' + (mn+1)).slice(-2) + '-'
             + yy;
