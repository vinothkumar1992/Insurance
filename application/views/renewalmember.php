...
<h4 class="text-center" style="margin-top:0;margin-bottom:0;font-weight:500;color:inherit;vertical-align:baseline;font-size:24px;line-height:28.8px" align="center">Thank you for Renewing with Us!</h4>
<h5 class="text-muted text-center" style="margin-top:0;margin-bottom:0;font-weight:500;color:#636c72;vertical-align:baseline;font-size:20px;line-height:24px" align="center"> Your Membership has been renewed :  </h5>
<h5 class="text-muted text-center" style="margin-top:0;margin-bottom:0;font-weight:500;color:#636c72;vertical-align:baseline;font-size:20px;line-height:24px" align="center">Membership ID :  <?php echo $policy; ?> </h5>
...
<a href="https://myangkasaemas.com/MEMBERS/" style="font-size:20px;font-family:Helvetica,Arial,sans-serif;text-decoration:none;border-radius:4.8px;line-height:30px;display:inline-block;font-weight:normal;white-space:nowrap;background-color:#007bff;color:#fff;padding:8px 16px;border:1px solid #007bff">Your Login Link </a>
</td>
</tr>
</tbody>
</table>
