...
<!-- begin:: Content -->
	...
	<?php echo form_open(base_url()."ConsultantsExt/saveagent",array('id'=>'kt_form','class'=>'kt-form','method'=>'post')); ?>
													...
													<div class="kt-form__section kt-form__section--first">
															...
															<div class="form-group">
																<label>Title</label>
																	...
																	<?php if($agent_level =="")  {?>		<option value="GM">Group Manager</option> <?php } ?>
																	<?php if($agent_level !="CS")  {?>		<option value="SM">Senior Manager</option> <?php } ?>
...
<!-- end:: Footer -->
 ...
 <?php //$this->load->view('agentform'); ?>
  ...
  <!--begin::Modal-->
	...
	<script src="<?php echo base_url();?>assets/js/addagentExt.js?v=<?php echo date("ymdhmi");?>" type="text/javascript"></script>
