...
<a href="<?php echo $link; ?>" style="font-size:20px;font-family:Helvetica,Arial,sans-serif;text-decoration:none;border-radius:4.8px;line-height:30px;display:inline-block;font-weight:normal;white-space:nowrap;background-color:#007bff;color:#fff;padding:8px 16px;border:1px solid #007bff">Click to Sign the Form</a>
</td>
</tr>
</tbody>
</table>
