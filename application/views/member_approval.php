...
<div class="kt-widget1__item">
                                                            ...
                                                            <?php if(isset($membershipid)) { ?>															
															
															<div class="kt-widget1__item">
																	<div class="kt-widget1__info">
																		<h3 class="kt-widget1__title">Membership ID </h3>
																		<span class="kt-widget1__desc"><?php echo $membershipid; ?></span>
																	</div>
										...
										<div class="kt-widget1__item">
																	<div class="kt-widget1__info">
																		<h3 class="kt-widget1__title">Payment Date </h3>
																		<span class="kt-widget1__desc"><?php echo $form_payment_date ; ?></span>
																	</div>
																...
																<div class="kt-widget1__item">
																	<div class="kt-widget1__info">
																		<h3 class="kt-widget1__title">Submission Date </h3>
																		<span class="kt-widget1__desc"><?php echo $form_submission_date ; ?></span>
																	</div>
											...
											<div class="kt-widget1">
												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<?php echo form_open('#',array('action'=>'#','class'=>'kt-form kt-form--label-right','method'=>'post')); ?>
														...
														<input type="hidden" name="pymntdate" value="<?php echo $form_payment_date; ?>" />
														
														<?php } ?>
														
															<button type="button" id="pa_pac" class="btn btn-brand">Member Approval</button>
														</form>
														</div>
													</div>
												</div>
...
<!-- end:: Footer -->
  ...
  <!-- The Modal  End -->
	...
	<!-- begin::Global Config(global config for global JS sciprts) -->
		...
		<script src="<?php echo base_url();?>assets/js2/ma.js?v=<?php echo date("ymdhmi");?>" type="text/javascript"></script>
