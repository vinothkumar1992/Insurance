										...
										<div class="dropdown">
												 ...
												 New Member Form
																...
																<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
																	<a class="dropdown-item" href="<?php echo base_url();?>MemberForm/newform/0"><i class="la la-edit"></i> Create New Member Form </a>
																<button class="dropdown-item" data-toggle="modal"  data-target="#sendlink" data-record-id="0" > <i class="la la-link"></i> Send New Member Form Link </button>
																</div>
															</div>
										</div>
									</div>
...
<!-- end:: Footer -->
 ...
 <!-- Model Link Start -->
   ...
   <?php $this->load->view("sendsignpadlink");?>
  ...
  <!-- Model Link End -->
	...
	<!-- begin::Global Config(global config for global JS sciprts) -->
		...
		<script src="<?php echo base_url();?>assets/js2/forms-ajax.js?v=<?php echo date("ymdhmi");?>" type="text/javascript"></script>
