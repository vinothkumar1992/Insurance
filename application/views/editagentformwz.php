...
<!-- begin:: Content -->
								...
								<div class="kt-portlet__body kt-portlet__body--fit">
									<div class="kt-grid  kt-wizard-v2 kt-wizard-v2--white" id="kt_wizard_v2" data-ktwizard-state="step-first">
										...
										<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v2__wrapper">
                                          <input type="hidden" id="agentid" name="agentid" value="<?php echo $agent_id ?> ">
	...
	<?php echo form_open(base_url()."Consultants/approveagent/".$agent_id,array('id'=>'kt_form','class'=>'kt-form','method'=>'post')); ?>
												<!--begin: Form Wizard Step 2-->
												<div class="kt-heading kt-heading--md">Agent Details</div>
												<div>
												<label><h6>GM Name : </h6> </label> <input type="text" class="form-control" id="agent_gmname"  disabled>
												<label><h6>GM No :</h6> </label> <input type="text" class="form-control" id="agent_gmno" disabled>
												</div>
<label><h6>SM Name :</h6> </label> <input type="text" class="form-control" id="agent_smname" disabled>
												<label><h6>SM No :</h6> </label> <input type="text" class="form-control" id="agent_smno" disabled>
												...
												<div class="kt-wizard-v2__content" data-ktwizard-type="step-content">
													...
													<div class="kt-form__section kt-form__section--first">
															...
															<div class="form-group">
																<label>Title</label>
																	<select name="agent_level" id="agent_level" class="form-control" disabled>
															...
															<input type="hidden"  class="form-control"  id="agent_no" name="agent_no" value=''>
															</div>
															<div class="row">
...
<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
																	<div class="form-group">
																		...
																		<input type="text" class="form-control mb-1" id="company" name="company"  >
...
<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
																	<div class="form-group">
																		...
																		<input type="text" class="form-control mb-1" id="position" name="position" >
...
<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
																	<div class="form-group">
																		<label>From</label>
																		<input type="date" class="form-control mb-1"  id="date_from" name="date_from"  >
...
<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
																	<div class="form-group">
																		<label>To</label>
																		<input type="date" class="form-control mb-1"  id="date_to" name="date_to" >
...
<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
																	<div class="form-group">
																		...
																		<input type="text" class="form-control mb-1" id="leaving_reason" name="leaving_reason">
...
<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
													...
													<div class="kt-form__section kt-form__section--first">
														...
														<div class="form-group">
															...
															<div class="kt-radio-inline mb-2">
																<label class="kt-radio">
																	<input type="radio" name="other_ans" id="answer" value="Yes"> Yes 
																	<span></span>
																</label>
																<label class="kt-radio">
																	<input type="radio" name="other_ans"  id="answer1" value="No"> No
																	<span></span>
																</label>
															</div>
													...
													<div class="kt-form__section kt-form__section--first">
														...
														<div class="row">
															...
															<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
																<div class="form-group">
																	<label>Old NRIC No/ No. KP Lama</label>
																	<input type="text" class="form-control" id="oldnric_no" name="oldnric_no"  >
																	<span class="form-text text-muted"></span>
																</div>
															</div>
														</div>
														<div class="form-group">
															...
															<div class="kt-radio-inline mb-2">
																...
																<label class="kt-radio">
																	<input type="radio" name="answer2" id="answer21" value="No"> No
																	<span></span>
																</label>
															</div>
												...
												<div class="kt-wizard-v2__content" data-ktwizard-type="step-content">
													...
													<label>NRIC Front Page</label>
														<div class="form-group">
												<!--<input type="hidden" name="agent_ic_copy" id ="agent_ic_copy"/> -->
												<input type="file" name="agent_ic_copy" id ="agent_ic_copy"/><br> 
												
					
                                              <div id='agent_ic_copy_img'> </div>
													...
													<div class="row">
																...
																<div class="form-group">
																	<label>Approve Status</label>
																		<select name="agent_approval" id="agent_approval" class="form-control">
																			<option value="">Select</option>
																...
																<div class="form-group">
																<label>Team</label>
																	<select name="agent_team" id="agent_team" class="form-control">
																		<option value="">Select</option>
																		<option value="3">HQ-1 (N&L)</option>
																		<option value="4">HQ-2 (A)</option>
																		<option value="5">HQ-3 (T)</option>
																		<option value="6">HQ-4 (Y) </option>
																	</select>
																<span class="form-text text-muted"></span>
															</div>
...
<!-- end:: Footer -->
 ...
 <?php //$this->load->view('agentform'); ?>
  ...
  <!--begin::Modal-->
	...
	<script src="<?php echo base_url();?>assets/js/editagent.js?v=<?php echo date("ymdhmi");?>" type="text/javascript"></script>
