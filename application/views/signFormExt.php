...
<hr>	
<h5 ><font color="#1D4C9C"><pre class="tab"> Name of the proposer : <?php echo $this->input->get("form_name");?>              NRIC No: <?php echo $this->input->get("form_nric");?> </pre> </font>   </h5>
<h5> Signature of the Proposer 
<form id="formsubmit" action="<?php echo base_url(); ?>MemberSignExt/signatureSubmit?token=<?php echo $this->input->get("token");?>"  method="post">
